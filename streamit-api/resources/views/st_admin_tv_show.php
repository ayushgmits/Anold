<?php
$tvShowData = get_option('streamit_app_tv_show');
// $movieTvShowList = getSTTVShowList()->toArray();

$dynamicShowType = get_option('default_show_type', 'tv_show_audio_series');
...
<div class="card p-0">
    <div class="card-body">
        <form name="st-admin-option-tv-show" id="st-admin-option-tv-show" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-12">
                    <h5>
                        <?php echo esc_html__('TV Show Banner', 'streamit-plugin-lang') ?>
                    </h5>
                    <hr>
                </div>
                <div class="col-lg-2">
                ...
                <div class="col-lg-10">
                    <div id="tv-show-banner-slide" class="st-clone-master" data-accordion="true">
                        <?php
                        if (isset($tvShowData['banner']) && count($tvShowData['banner']) > 0) {
                            foreach ($tvShowData['banner'] as $i1 => $d1) {
                                ?>
                                <div class="card st-clone-item">
                                    <div class="card-header st-accordion-header collapsed"
                                         id="tv-show-banner-slide-<?php echo($i1 + 1); ?>"
                                         data-toggle="collapse"
                                         data-target="#tv-show-banner-slide-body-<?php echo($i1 + 1); ?>"
                                         aria-expanded="false"
                                         aria-controls="tv-show-banner-slide-body-<?php echo($i1 + 1); ?>">
                                    ...
                                    <div id="tv-show-banner-slide-body-<?php echo($i1 + 1); ?>"
                                         class="collapse st-accordion-body"
                                         aria-labelledby="tv-show-banner-slide-<?php echo($i1 + 1); ?>"
                                         data-parent="#tv-show-banner-slide">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-md-12">
                                                    <label>TV Show</label>
                            ...
                            ?>
                            <div class="card st-clone-item">
                                <div class="card-header st-accordion-header collapsed" id="tv-show-banner-slide-1"
                                     data-toggle="collapse"
                                     data-target="#tv-show-banner-slide-body-1" aria-expanded="false"
                                     aria-controls="tv-show-banner-slide-body-1">
                                ...
                                <div id="tv-show-banner-slide-body-1" class="collapse st-accordion-body"
                                     aria-labelledby="tv-show-banner-slide-1" data-parent="#tv-show-banner-slide">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label>TV Show</label>
                ...
                <div class="col-lg-10">
                    <div id="tv-show-sub-slider" class="st-clone-master" data-accordion="true">
                        <?php
                        if (isset($tvShowData['sliders']) && count($tvShowData['sliders']) > 0) {
                            foreach ($tvShowData['sliders'] as $i2 => $d2) { ?>
                                <div class="card st-clone-item">
                                    <div class="card-header st-accordion-header collapsed"
                                         id="tv-show-sub-slider-<?php echo($i2 + 1); ?>"
                                         data-toggle="collapse"
                                         data-target="#tv-show-sub-slider-body-<?php echo($i2 + 1); ?>"
                                         aria-expanded="false"
                                         aria-controls="tv-show-sub-slider-body-<?php echo($i2 + 1); ?>">
                                        <span class="m-0 h6 text-center cursor-pointer st-clone-header"
                                              data-title="Slider">
                                    ...
                                    <div id="tv-show-sub-slider-body-<?php echo($i2 + 1); ?>"
                                         class="collapse st-accordion-body"
                                         aria-labelledby="tv-show-sub-slider-<?php echo($i2 + 1); ?>"
                                         data-parent="#tv-show-sub-slider">
                                        <div class="card-body">
                                            <div class="row">
                                                <div class="col-lg-12">
                                                    <label>Title</label>
                                                ...
                                                <div class="col-lg-6 mt-3">
                                                    ...
                                                    <select class="form-control st-multiple-checkboxes"
                                                            ...
                                                            data-actions-box="true" x-placement="Select Tags">
                                                        <?php
                            ...
                            ?>
                            <div class="card st-clone-item">
                                <div class="card-header st-accordion-header collapsed" id="tv-show-sub-slider-1"
                                     data-toggle="collapse"
                                     data-target="#tv-show-sub-slider-body-1" aria-expanded="false"
                                     aria-controls="tv-show-sub-slider-body-1">
                                ...
                                <div id="tv-show-sub-slider-body-1" class="collapse st-accordion-body"
                                     aria-labelledby="tv-show-sub-slider-1" data-parent="#tv-show-sub-slider">
                                    <div class="card-body">
                                        <div class="row">
                                            <div class="col-md-12">
                                                <label>Title</label>
                ...
                <div class="col-md-12">
                    <hr class="mb-3">
                    <button type="button" class="btn btn-info mt-2" id="st-tv-show-admin-setting">
